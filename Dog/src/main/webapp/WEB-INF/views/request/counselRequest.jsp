...
<!--=====================================움직이는 로고================================-->
   ...
   <div id="allDiv" style="min-height: 1000px;">
...
<!--=====================================상담신청칸================================-->
      ...
      <div id="requestDiv" style="padding-left:0px; width:850px;">
         <div class="sign-in-container">
                 ...
                 <div id="form">
                   ...
                   <div class="radio-group">
                         <label for="preschool">
                             <input type="radio" id="preschool" value="A" name="consultationType" style="width:20px; vertical-align: middle;" checked> 유치원 입학상담
                         </label>&nbsp;&nbsp;&nbsp;
                         <label for="hotelRegist">
                             <input type="radio" id="hotelRegist" value="B" name="consultationType" style="vertical-align: middle;"> 호텔 예약상담
                         </label>
                     </div>
                     <br>
                     <div><div class="orange-dot"></div>&nbsp;&nbsp;보호자 성함&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                    <input type="text" id="userName" name="userName" placeholder="name" value="${loginUser.uName}">
                    <br>
                     <div><div class="orange-dot"></div>&nbsp;&nbsp;이메일&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                    <input type="email" id="email" name="email" placeholder="email" value="${loginUser.email }">
                    <br>
                    <div><div class="orange-dot"></div>&nbsp;&nbsp;신청일자&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                    <input type="date" id="requestTime1" name="day" >
                    <input type="time" id="requestTime2" name="time">
                 </div>
         ...
         <div class="overlay-right" style="margin-right:80px;">
            ...
            <textarea id="information" name="dogInfo" placeholder="상담받고 싶은 반려견의 내용을 간단히 적어주세요." style="width:300px; height: 350px;"></textarea>
              <button type="button" id="signUp" class="overlay_btn">신청하기</button>
          </div>
        
      </div>
      
      
      <form method="POST" action="${contextPath }/insertRequest.do" id="realForm">
