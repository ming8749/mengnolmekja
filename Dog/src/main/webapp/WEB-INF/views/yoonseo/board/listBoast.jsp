    ...
    <script>
       window.onload = ()=> {
    	  /*  const btn = document.getElementById('sub-btn');
    	   ...
    	   const parentDivs = document.getElementsByClassName('list-select3');
    	   for (const parentDiv of parentDivs) {
    		   parentDiv.addEventListener('click', function (){
    			   const divs = parentDiv.children;
    			   const boardNo = divs[0].innerText;
    			   console.log(boardNo);
    			   location.href = '${ contextPath }/selectBoard3.go?boardNo='
