   ...
   <c:set value="${ pageContext.servletContext.contextPath }" var="contextPath"
    ...
    <div class="board_wrap">
        <div class="board_title">
            ...
            <p>질의응답 게시글은 총 ${ count }개 입니다.</p>
        </div>
        
        <div>
           <button class="boardBtn" onclick="location.href='${contextPath}/list.go'">후기</button>
           <button class="boardBtn" onclick="location.href='${contextPath}/list3.go'" >자유</button>
           <button class="boardBtn" id="answer">질의응답</button>
        ...
        <div class="board_list_wrap">
            ...
            <div class="search">
               <select style="border:1px solid black;" id="selectSearch" name="select">
                  <option>아이디검색</option>
                  <option>제목검색</option>
                  <option>내용검색</option>
               </select>
    ...
    <script>
       window.onload = ()=> {
    	  /*  const btn = document.getElementById('sub-btn');
    	   ...
    	   const parentDivs = document.getElementsByClassName('list-select2');
    	   for (const parentDiv of parentDivs) {
    		   parentDiv.addEventListener('click', function (){
    			   ...
    			   console.log(boardNo);
    			   location.href = '${ contextPath }/selectBoard2.go?boardNo='
